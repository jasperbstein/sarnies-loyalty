...
export interface User {
  ...
  company?: string; // Freetext company name (deprecated - use company_id)
  gender?: string;
...
export interface StaffUser {
  ...
  created_at: Date;
  updated_at: Date;
  // New field from migration 001
  branch: 'Sukhumvit' | 'Old Town' | 'Roastery';
}

// New interfaces from migration 002
...
// New interfaces from migration 006

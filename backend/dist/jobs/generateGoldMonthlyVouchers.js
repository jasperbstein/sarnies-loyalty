...
exports.generateGoldMonthlyVouchers = generateGoldMonthlyVouchers;
...
async function generateGoldMonthlyVouchers() {
    ...
    try {
        ...
        const settingsResult = await (0, database_1.query)("SELECT setting_value FROM app_settings WHERE setting_key = 'gold_monthly_voucher_id'");
        ...
        // Get voucher details
        const voucherResult = await (0, database_1.query)('SELECT * FROM vouchers WHERE id = $1 AND is_active = true', [goldVoucherId]);
        ...
        const eligibleUsersResult = await (0, database_1.query)(`
...
//# sourceMappingURL=generateGoldMonthlyVouchers.js.map
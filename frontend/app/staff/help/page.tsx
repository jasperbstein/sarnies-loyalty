      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="px-5 pb-6 space-y-3">
          {sections.map((section) => {
            ...
            return (
              <div key={section.id} className="bg-white rounded-xl border border-[#E7E5E4] overflow-hidden">
                <button
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[15px] font-semibold text-[#1C1917]" style={{ fontFamily: 'Instrument Sans, sans-serif' }}>
                      {section.title}
                    </span>
                  </div>
                  <ChevronRight className={`w-5 h-5 text-[#A8A29E] transition-transform ${isExpanded ? 'rotate-90' : ''}`} />
                </button>
          ...
          {/* Contact Support */}
          <div className="bg-[#F5F5F4] rounded-xl p-4 text-center mt-6">
            <HelpCircle className="w-8 h-8 text-[#78716C] mx-auto mb-2" />
            <p className="text-[14px] font-semibold text-[#1C1917]" style={{ fontFamily: 'Instrument Sans, sans-serif' }}>
              Need more help?
            </p>
            <p className="text-[13px] text-[#78716C] mt-1" style={{ fontFamily: 'Instrument Sans, sans-serif' }}>

  ...
  runtimeCaching: [
    ...
    },
    {
      ...
      options: {
        ...
        expiration: {
          maxEntries: 16,
          maxAgeSeconds: 60 // 1 minute for API responses
        }
      }
    },
    {
...
const nextConfig = {
  ...
  images: {
    ...
    domains: ['loyalty.sarnies.tech', 'localhost', 'images.unsplash.com', 'picsum.photos', 'images.pexels.com'],
